...
- macOS: finish WISEBot app rename for macOS sources, bundle identifiers, and shared kit paths. (#2844) Thanks @fal3.
...
- Branding: normalize legacy casing/branding to “WISEBot” (CLI, status, docs).
