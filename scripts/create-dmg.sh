...
#
# Env:
#   DMG_VOLUME_NAME        default: CFBundleName (or "WISEBot")
...
APP_NAME=$(/usr/libexec/PlistBuddy -c "Print CFBundleName" "$APP_PATH/Contents/Info.plist" 2>/dev/null || echo "WISEBot")
